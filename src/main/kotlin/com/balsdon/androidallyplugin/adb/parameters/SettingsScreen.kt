...
enum class SettingsScreen(val identifier: String, val source: String) {
    ...
    COLOR("panel.debug.label.screen.colors", "com.android.settings.ACCESSIBILITY_COLOR_SPACE_SETTINGS"),
